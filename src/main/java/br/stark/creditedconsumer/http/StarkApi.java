 ...
 */
package br.stark.creditedconsumer.http;

import br.stark.creditedconsumer.repository.TransferRepository;
import br.stark.creditedconsumer.util.DecimalUtil;
 ...
 * @author lucas
 */
public class StarkApi implements TransferRepository {

    @Override
    public void transfer(br.stark.creditedconsumer.model.Transfer transferData) throws Exception {
